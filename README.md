...
- Cargo documentation keeps this [hidden in Cargo book's
...
`rust-toolchain.toml` have (for example) `channel = "nightly-2022-08-27"`. This also helps when
figuring out the [Minimum Supported Rust
Version](https://rust-lang.github.io/rfcs/2495-min-rust-version.html) for your crates.
