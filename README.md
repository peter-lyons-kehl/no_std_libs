...
`rust-toolchain.toml` have (for example) `channel = "nightly-2022-08-27"`.

Some Rust versions also qualify for the minimum supported Rust version -
[`rust-version`](https://doc.rust-lang.org/nightly/cargo/reference/manifest.html#the-rust-version-field)
in your crate's `Cargo.toml > [package]`.
